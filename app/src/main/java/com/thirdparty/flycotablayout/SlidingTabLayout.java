package com.thirdparty.flycotablayout;

/*
  Copied from FlycoTabLayout
  Also converted to AndroidX
  Thanks to H07000223
*/
    ...
    private void calcIndicatorRect() {
        ...
        if (mIndicatorWidth >= 0) {
            ...
            if (this.mCurrentTab < mTabCount - 1) {
                ...
                indicatorLeft = indicatorLeft + mCurrentPositionOffset * ((int)(currentTabView.getWidth() / 2) + (int)(nextTab.getWidth() / 2));
            }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIndicatorStyle == STYLE_TRIANGLE) {
            if (mIndicatorHeight > 0) {
                ...
                mTrianglePath.lineTo(paddingLeft + (int)(mIndicatorRect.left / 2) + (int)(mIndicatorRect.right / 2), height - mIndicatorHeight);
